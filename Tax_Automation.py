...
print('3. 모든 파일은 C:\\업무자동화 폴더 안에 존재해야함\n\n잠시만 기다려주십시오...\n')
...
for name in file_names :
    if str('고객파일_GL반도체') in name :
        file1 = os.path.join(path, name)
    elif str('출하파일_GL반도체') in name :
...
of3 = openpyxl.load_workbook(r'C:\업무자동화\세금계산서등록양식일반.xlsx')
...
na = int(input("몇 월 자료입니까? (ex.01/02/.../10/11/12) : "))
...
messagebox.showinfo("알림", "정상 처리되었습니다!")
...
of3.save(r'C:/업무자동화/result.xlsx')
